...
pub fn diagnostic_background(severity: DiagnosticSeverity, cx: &App) -> Hsla {
...
pub fn diagnostic_foreground(severity: DiagnosticSeverity, cx: &App) -> Hsla {
    let status = &cx.theme().highlight_theme.style.status;
    match severity {
...
pub fn diagnostic_border(severity: DiagnosticSeverity, cx: &App) -> Hsla {
    let status = &cx.theme().highlight_theme.style.status;
    match severity {
